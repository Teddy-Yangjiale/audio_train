...
def main():
    parser = argparse.ArgumentParser(description="Train Audio1DCNN")
    ...
    model = create_model("cnn", num_classes=len(label_names), in_channels=in_channels)
    ...
    trainer.save_model("audio_cnn_v1.pth")
